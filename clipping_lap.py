...
def build_figure(df, meta):
    ...
    gs = fig.add_gridspec(
        2, 1, height_ratios=[1.3, 1], hspace=0.22,
...
def run(df, meta):
    ...
    ax_map.legend(
        ...
        fontsize=10, facecolor=BG, edgecolor=GRID,
    ...
    def update(frame_num):
        ...
        throttle_artist = ax_thr.fill_between(
            sub["Distance"], 0, sub["Throttle"], alpha=0.06, color=THROTTLE_FILL
        )
